<template>
  <div>
    ...
    <button @click="generatePDF" id="downloadButton" style="color:white"
...
export default {
  ...
  async created(){
    ...
    const res= await axios.get(`https://certify-verify.onrender.com/certs/${localStorage.getItem("certId")}`);
